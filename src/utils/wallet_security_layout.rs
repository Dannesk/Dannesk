...
pub fn WalletSecurityForm(
    ...
    rsx! {
        style { {r#"
            ...
            .terminal-input-wrapper { display: flex; align-items: center; background: var(--input-bg); /* Use the white background here too */ border: 1px solid var(--border); padding: 0.8rem 1rem; }
