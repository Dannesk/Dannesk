...
use crate::channel::{
    ActiveView, CHANNEL, ProgressState, SignTradeState, WSCommand, XrpModalState,
};
...
impl TradeLogic {
    ...
    pub async fn process(
        ...
        let offer_amount_val = amount_f * price_f; // ← this stays correct
        ...
        match ws_tx.try_send(cmd) {
            Ok(_) => {
                ...
                let _ = CHANNEL.trade_tx.send(SignTradeState { send_trade: None });
