...
pub fn SendAuthForm(
    ...
    rsx! {
        style { {r#"
            .send-step-container { display: flex; flex-direction: column; width: 100%; max-width: 800px; margin: 0 auto; font-family: 'JetBrains Mono', monospace; padding: 2rem; box-sizing: border-box; }
            ...
            /* Box-sizing: border-box is the key to matching widths exactly */
            ...
            .footer-nav { margin-top: 2rem; display: flex; justify-content: flex-end; align-items: center; }
        "#} }
