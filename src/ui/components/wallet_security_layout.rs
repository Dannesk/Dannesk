    ...
    rsx! {
        style { {r#"
            .terminal-step-container {
                ...
                /* Hard width (fixed) satisfies WGPU without needing a visible border */
                width: 800px; 
                margin: 0 auto;
            ...
            /* Keeping the input wrapper background white/transparent as per your original preference */
        ...
        div { class: "terminal-step-container",
            ...
            // 1. Encryption Section (Primary Security Layer)
            ...
            // 2. BIP39 Section (Optional Passphrase)
            div { class: "input-section",
                div { class: "input-label-row",
